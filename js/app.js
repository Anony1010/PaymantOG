...
// ============================================
// ADMIN LOGIN MODAL (Code: 66)
// ============================================

const ADMIN_CODE = '66';
const ADMIN_SESSION_KEY = 'gasham_admin_session';

function adminCheckSession() { return localStorage.getItem(ADMIN_SESSION_KEY) === 'true'; }
function adminSaveSession() { localStorage.setItem(ADMIN_SESSION_KEY, 'true'); }

// Admin button
$('admin-btn')?.addEventListener('click', () => {
  if (adminCheckSession()) {
